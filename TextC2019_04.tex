...
\newcommand{\codepath}{../../code/04}
\newcommand{\articlepath}{./article/04}
...
\include{\articlepath/array.tex}

\include{\articlepath/doublearray.tex}

\include{\articlepath/exercise.tex}
