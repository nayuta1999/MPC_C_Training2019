...
\begin{document}
\maketitle
\include{\articlepath/hukusyu}%前回の復習
\include{\articlepath/double_pointa}%ポインタのポインタ
\include{\articlepath/string}%文字列
\include{\articlepath/not_C_string}
\include{\articlepath/sakaki_exercise}%文字列
\include{\articlepath/papy_exercise}%文字列
\section*{参考文献}
\noindent
[1]昨年までの講座資料\newline
