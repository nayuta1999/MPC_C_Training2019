...
\newcommand{\codepath}{./code/07}
\newcommand{\articlepath}{./article/07}
...
\begin{document}
\maketitle
\include{\articlepath/variable}%変数の再確認
\include{\artilclepath/point}%変数とポインタ
\include{\articlepatj/arraypointa}%配列とポインタの関係
\end{document}
