...
\title{C言語講座第11回}%何回か書き直す
\author{MPC部員}
\date{2019年}%日付も書き直す
\begin{document}
\maketitle
\include{\articlepath/hukusyu}
\include{\articlepath/file_mode}%記事を追加する
\include{\articlepath/file_output}
\include{\articlepath/file_input}
\include{\articlepath/papy_exercise}
\include{\articlepath/sakaki_exercise}
\include{\articlepath/takerou_exercise}
\section*{参考文献}
\noindent
[1]昨年までの講座資料\newline
